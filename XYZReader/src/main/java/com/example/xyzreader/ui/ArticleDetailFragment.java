...
//        updateStatusBar();
   ...
   /* private void updateStatusBar() {
    ...
    private void bindViews() {
        ...
        bodyView.setTypeface(Typeface.createFromAsset(getResources().getAssets(), "Roboto-MediumItalic.ttf"));
...
//remove all '>' from text such as '> regardless' but leave the very first '>' in tact
